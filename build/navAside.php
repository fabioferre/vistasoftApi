            ...
            <div class="row">
               ...
               <div class="col-sm-12 col-xs-12">
                  <div class="features-list field-expand">
                     <div class="clearfix"></div><label class="checkbox-inline"><input name="carac[Aberturas]" id="feature-aberturas" value="Sim" type="checkbox">Aberturas</label><label class="checkbox-inline"><input name="carac[Adega]" id="feature-adega" value="Sim" type="checkbox">Adega</label><label class="checkbox-inline"><input name="carac[ArCentral]" id="feature-ar-central" value="Sim" type="checkbox">Ar Central</label><label class="checkbox-inline"><input name="carac[AquecimentoCentral]" id="feature-ar-condicionado" value="Sim" type="checkbox">Aquecimento central</label><label class="checkbox-inline"><input name="carac[AreaServico]" id="feature-area-de-servico" value="Sim" type="checkbox">Área de Serviço</label><label class="checkbox-inline"><input name="carac[BanheiroAuxiliar]" id="feature-banheiro-senhor" value="Sim" type="checkbox">Banheiro Auxiliar</label><label class="checkbox-inline"><input name="carac[BanheiroSocial]" id="feature-banheiro-senhora" value="Sim" type="checkbox">Banheiro Sócial</label><label class="checkbox-inline"><input name="carac[Bicicletario]" id="feature-biblioteca" value="Sim" type="checkbox">Bicicletario</label><label class="checkbox-inline"><input name="carac[Closet]" id="feature-Closet" value="Sim" type="checkbox">Closet</label><label class="checkbox-inline"><input name="carac[Churrasqueira]" id="feature-churrasqueira" value="Sim" type="checkbox">Churrasqueira</label><label class="checkbox-inline"><input name="carac[ChurrasqueiraCondominio]" id="feature-ChurrasqueiraCondominio" value="Sim" type="checkbox">Churrasqueira C.</label><label class="checkbox-inline"><input name="carac[CircuitoFechadoTV]" id="feature-circuito-de-tv" value="Sim" type="checkbox">Circuito de TV</label><label class="checkbox-inline"><input name="carac[CozinhaAmericana]" id="feature-CozinhaAmericana" value="Sim" type="checkbox">Cozinha Americana</label><label class="checkbox-inline"><input name="carac[CopaCozinha]" id="feature-copa-cozinha" value="Sim" type="checkbox">Copa Cozinha</label><label class="checkbox-inline"><input name="carac[CozinhaMontada]" id="feature-CozinhaMontada" value="Sim" type="checkbox">Cozinha Montada</label><label class="checkbox-inline"><input name="carac[CozinhaPlanejada]" id="feature-cozinha-planejada" value="Sim" type="checkbox">Cozinha Planejada</label><label class="checkbox-inline"><input name="carac[Despensa]" id="feature-dependencia-de-empregados" value="Sim" type="checkbox">Dep. Empregados</label><label class="checkbox-inline"><input name="carac[Deposito]" id="feature-deposito" value="Sim" type="checkbox">Depósito</label><label class="checkbox-inline"><input name="carac[Despensa]" id="feature-despensa" value="Sim" type="checkbox">Despensa</label><label class="checkbox-inline"><input name="carac[Edicula]" id="feature-edicula" value="Sim" type="checkbox">Edícula</label><!-- <label class="checkbox-inline"><input name="feature[]" id="feature-escritorio" value="Sim" type="checkbox">Escritório</label> --><label class="checkbox-inline"><input name="carac[EspacoGourmet]" id="feature-espaco-gourmet" value="Sim" type="checkbox">Espaço Gourmet</label><label class="checkbox-inline"><input name="carac[GasCentral]" id="feature-gas-central" value="Sim" type="checkbox">Gás Central</label><label class="checkbox-inline"><input name="carac[HomeTheater]" id="feature-home-theater" value="Sim" type="checkbox">Home Theater</label><label class="checkbox-inline"><input name="carac[Interfone]" id="feature-interfone" value="Sim" type="checkbox">Interfone</label><label class="checkbox-inline"><input name="carac[Jardim]" id="feature-jardim" value="Sim" type="checkbox">Jardim</label><label class="checkbox-inline"><input name="carac[JardimInverno]" id="feature-jardim-de-inverno" value="Sim" type="checkbox">Jardim de Inverno</label><!-- <label class="checkbox-inline"><input name="feature[]" id="feature-jardim-miraflores" value="Sim" type="checkbox">Jardim Miraflores</label> --><label class="checkbox-inline"><input name="carac[Lareira]" id="feature-lareira" value="Sim" type="checkbox">Lareira</label><label class="checkbox-inline"><input name="carac[Lavabo]" id="feature-lavabo" value="Sim" type="checkbox">Lavabo</label><label class="checkbox-inline"><input name="carac[Living]" id="feature-living" value="Sim" type="checkbox">Living</label><label class="checkbox-inline"><input name="carac[Piscina]" id="feature-piscina" value="Sim" type="checkbox">Piscina</label><label class="checkbox-inline"><input name="carac[PiscinaAquecida]" id="feature-PiscinaAquecida" value="Sim" type="checkbox">Piscina Aquecida</label><label class="checkbox-inline"><input name="carac[Playground]" id="feature-playground" value="Sim" type="checkbox">Playground</label><label class="checkbox-inline"><input name="carac[Portaria]" id="feature-Portaria" value="Sim" type="checkbox">Portaria</label><label class="checkbox-inline"><input name="carac[Portaria24Hrs]" id="feature-portaria-24h" value="Sim" type="checkbox">Portaria 24H</label><!-- <label class="checkbox-inline"><input name="feature[]" id="feature-prataria-e-loucaria" value="Sim" type="checkbox">Prataria e Louçaria</label> --><label class="checkbox-inline"><input name="carac[Quadra]" id="feature-Quadra" value="Sim" type="checkbox">Quadra</label><label class="checkbox-inline"><input name="carac[QuadraPoliEsportiva]" id="feature-quadra-poliesportiva" value="Sim" type="checkbox">Q. Poliesportiva</label><!-- <label class="checkbox-inline"><input name="feature[]" id="feature-quarto-de-motorista" value="Sim" type="checkbox">Qto. Motorista</label> --><label class="checkbox-inline"><input name="carac[QuadraTenis]" id="feature-quadra-de-tenis" value="Sim" type="checkbox">Quadra de Tênis</label><label class="checkbox-inline"><input name="carac[Sala]" id="feature-sala-de-estar" value="Sim" type="checkbox">Sala de Estar</label><label class="checkbox-inline"><input name="carac[SalaJantar]" id="feature-sala-de-jantar" value="Sim" type="checkbox">Sala de Jantar</label><label class="checkbox-inline"><input name="carac[SalaFitness]" id="feature-sala-fitness" value="Sim" type="checkbox">Sala Fitness</label><label class="checkbox-inline"><input name="carac[SalaoBrinquedo]" id="feature-sala-de-jogos" value="Sim" type="checkbox">Salão de brinquedos</label><!-- <label class="checkbox-inline"><input name="feature[]" id="feature-sala-intima" value="Sim" type="checkbox">Sala Íntima</label> --><label class="checkbox-inline"><input name="carac[SalaoFestas]" id="feature-salao-de-festas" value="Sim" type="checkbox">Salão de Festas</label><!-- <label class="checkbox-inline"><input name="feature[]" id="feature-salao-de-festas-2" value="Sim" type="checkbox">Salão de Festas</label> --><label class="checkbox-inline"><input name="carac[Sauna]" id="feature-sauna" value="Sim" type="checkbox">Sauna</label><label class="checkbox-inline"><input name="carac[SegurancaPatrimonial]" id="feature-seguranca" value="Sim" type="checkbox">Segurança</label><label class="checkbox-inline"><input name="carac[SuiteMaster]" id="feature-suite-americana" value="Sim" type="checkbox">Suíte Americana</label><label class="checkbox-inline"><input name="carac[Terraco]" id="feature-terraco" value="Sim" type="checkbox">Terraço</label><label class="checkbox-inline"><input name="carac[Varanda]" id="feature-varanda" value="Sim" type="checkbox">Varanda</label><!-- <label class="checkbox-inline"><input name="feature[]" id="feature-vestiario" value="Sim" type="checkbox">Vestiário</label> --><label class="checkbox-inline"><input name="carac[WCEmpregada]" id="feature-zelador" value="Sim" type="checkbox">WC Empregada</label> <label class="checkbox-inline"><input name="carac[Zelador]" id="feature-zelador" value="Sim" type="checkbox">Zelador</label> 
                  </div>
               </div>
            </div>
